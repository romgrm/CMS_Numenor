...
const rows = [
    createData('First Author', 'firstauthor@mail.com', <ViewButton /> ),
    createData('Second Author', 'secondauthor@mail.com', <ViewButton/>),
    createData('Third Author', 'thirdauthor@mail.com', <ViewButton/>)
];
